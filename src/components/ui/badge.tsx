  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary: "border-transparent bg-soft text-textMain",
        destructive: "border-transparent bg-red-100 text-red-800",
        outline: "text-textMain",
        live: "border-transparent bg-liveSoft text-live",
        pending: "border-transparent bg-accentSoft text-accent",
        resolved: "border-transparent bg-brandSoft text-brand",
      },
    },
    defaultVariants: {
      variant: "default",
